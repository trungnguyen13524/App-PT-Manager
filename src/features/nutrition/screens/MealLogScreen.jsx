      ...
      return items.map(item => {
        ...
        if (matchedFood) {
          return {
            ...
            protein: isObject && item.protein ? item.protein : Math.round(Number(matchedFood.Protein) || 0),
            carbs: isObject && item.carbs ? item.carbs : Math.round(Number(matchedFood.Carbohydrate) || 0),
            fat: isObject && item.fat ? item.fat : Math.round(Number(matchedFood.TotalFat) || 0),
